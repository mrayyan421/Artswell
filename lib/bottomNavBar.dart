  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Obx(
            () => NavigationBar(
              backgroundColor: kColorConstants.klPrimaryColor,
          labelTextStyle: WidgetStatePropertyAll(kTextTheme.lightTextTheme.displaySmall!.copyWith(fontWeight: FontWeight.w600)),
          selectedIndex: controller.selectedIndex.value,
          onDestinationSelected: (index) => controller.selectedIndex.value = index,
          destinations: const [
            NavigationDestination(icon: ImageIcon(AssetImage('assets/icons/home.png')), label: 'Home'),
            NavigationDestination(icon: ImageIcon(AssetImage('assets/icons/store.png')), label: 'Shop'),
            NavigationDestination(icon: ImageIcon(AssetImage('assets/icons/bidding.png')), label: 'Bidding'),
            NavigationDestination(icon: ImageIcon(AssetImage('assets/icons/cart.png')), label: 'Cart'),
            NavigationDestination(icon: ImageIcon(AssetImage('assets/icons/favorite.png')), label: 'Favorites'),
          ],
        ),
      ),
      body: Obx(
