...
/*class ProductCardVertical extends StatefulWidget {
  ...
  @override
  _ProductCardVerticalState createState() => _ProductCardVerticalState();
}
...
class _ProductCardVerticalState extends State<ProductCardVertical> {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: kSizes.productContainerHeight,
      width: kSizes.productContainerWidth,
      child: Container(
        padding: EdgeInsets.all(kSizes.smallestPadding),
        decoration: BoxDecoration(
          boxShadow: [kBoxShadow.verticalBoxShadow],
          borderRadius: BorderRadius.circular(kSizes.itemImgRadius),
          color: kColorConstants.klProductContainerBgColor,
        ),
        child: Column(
            ...
            Stack(
              children: [
                ...
                Positioned(
                  top: 8,
                  right: 0,
                  child: widget.isBidding
                      ? Container(
                    decoration: BoxDecoration(
                      color: Color.fromRGBO(225, 138, 1, 0.5),
                      borderRadius: BorderRadius.circular(kSizes.mediumPadding),
                    ),
                    child: Text(
                      'Biddable',
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    child: ImageIcon(
                      AssetImage(
                        widget.isFavorite ? 'assets/icons/favoriteColored.png' : 'assets/icons/favorite.png',
                      ),
                    ),
                    onTap: widget.onFavoriteToggle,
                  ),
              ...
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      'Price:',
                      style: kAppTheme.lightTheme.textTheme.titleMedium,
                    ),
                    Text(
                      'PKR ${widget.priceText}',
                      maxLines: 1,
                ...
                ElevatedButton(
                  onPressed: () => HomeController.instance.productDetailPageNavigation(context),
                  child: Text('Shop Now'),
                  style: ElevatedButton.styleFrom(
